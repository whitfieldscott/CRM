...
export function ContactsDirectory({
  ...
  return (
    <div className={embedded ? "space-y-6 cannacore-embedded-content" : "space-y-6"}>
      <Card>
        <CardHeader>
      ...
      <section className="cannacore-recent-contacts">
        <div className="cannacore-panel-header">
          <div className="cannacore-panel-title-plain">Contacts Directory</div>
        ...
        <div className="cannacore-contacts-columns">
          {[
            ...
            const columnContacts = contacts.filter(
              (c) => (c.license_type ?? "").toLowerCase() === key
            );
            return (
              <div key={key} className="cannacore-contacts-column">
                <div className="cannacore-contacts-column-header">
                  {label} ({columnContacts.length})
                </div>
